...
m = nlsLM(E ~ (aE*x)/(bE0+x) + 9 * ((aB*x)/(bB0+x)) * ((aV*x)/(bV0)) / 16 * ((((aV*x)/(bV0+x)*V)**(1/3))**2 - 1)**2 * (6 + ((aP*x)/(aP+x)) * ((((aV*x)/(bV0+x)*V)**(1/3))**2 - 1) - 4 * (((aV*x)/(bV0+x)*V)**(1/3))**2), start = list(aE=aE,aB=aB,aP=aP,aV=aV, bE0=1, bB0=1, bP0=1, bV0=1))
